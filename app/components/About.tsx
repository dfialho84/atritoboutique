      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="aspect-square overflow-hidden bg-gray-100 relative">
            ...
            <div className="absolute top-5 left-5 w-10 h-10 border-t border-l border-[#D4AF37]" />
            <div className="absolute bottom-5 right-5 w-10 h-10 border-b border-r border-[#D4AF37]" />
          </div>
          ...
          <div>
            ...
            <div className="space-y-5 text-gray-600 text-[0.95rem] leading-relaxed">
              <p>
